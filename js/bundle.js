...
function calc() {
  var result = document.querySelector('.calculating__result');
  var sex,
      height,
      weight,
      age,
  ...
  function calcTotal() {
    ...
    if (sex === 'female') {
      ...
      result.textContent = Math.rount((88.36 + 13.4 * weight + 4.8 * height - 5.7 * age) * ratio);
    }
  }
...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_3__.getResource)('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_9__.postData)('http://localhost:3000/requests', json).then(function () {
...
function slider(_ref) {
  ...
  function setAllSlidesView() {
    if (slides.length < 10) {
      ...
      total.textContent = "".concat(slides.length);
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimerId);
  }, 30000);
  ...
  (0,_modules_tabs_js__WEBPACK_IMPORTED_MODULE_6__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_7__.default)('.timer', '2021-02-04');
});
